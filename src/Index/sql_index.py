...
def __get_max_cluster_num__(dataset_name:str)->str:
    return "select max(num) from "+dataset_name+"_list ;"

def __create_meta_cluster__(dataset_name:str,num_strata:int) -> str:
...
def __add_to_cluster_meta__(dataset_name:str,num_strata:int,column:str,value_:str,p_l:float,p_g:float) ->str:
...
def __get_probability_dim_value_greater__(dataset_name:str,num_strata:int,dim:str,value_min:str)->str:
    return "select p_g from "+dataset_name+"_"+str(num_strata)+"_meta  where col='"+dim+"' and value_ = "+value_min+" - 1;"

def __get_probability_dim_value_lower__(dataset_name:str,num_strata:int,dim:str,value_max:str)->str:
    return "select p_l from "+dataset_name+"_"+str(num_strata)+"_meta  where col='"+dim+"' and value_ = "+value_max+" + 1"

def __add_cluster_to_index__(dataset_name:str,num:int,min_dim:str,max_dim:str,avg:str,spar:str)-> str:
...
def __clusters_in_range__(dataset_name:str,range_sql_min:str,range_sql_max:str)->str:
...
def __clusters__(dataset_name:str)->str:
    return "select num,avg from stratas_index_"+dataset_name+" ;"
def __clusters_all__(dataset_name:str)->str:
    return "select * from stratas_index_"+dataset_name+" ;"

def __clusters_in_range_with_dims__(dataset_name:str,range_sql_min:str,range_sql_max:str)->str:
...
def __clusters_in_range2__(dataset_name:str,range_sql:str):
